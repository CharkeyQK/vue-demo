  ...
  <div>
    ...
    <el-card class="overview-card">
      ...
      <el-row class="order-items" type="flex">
        <el-col :span="13">
          <el-row class="orderInfoClass" type="flex" align="middle" v-for="item in data.orderItems">
            <el-col :span="4">
              <div class="order-image">
                <img v-bind:src="item.itemImg" style="width: 5em;height: 5em; vertical-align: middle;">
              </div>
            </el-col>
            <el-col :span="12">
